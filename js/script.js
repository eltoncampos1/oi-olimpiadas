$(document).ready(() => {
  $("#btn-enviar").on("click", (e) => {
    ...
    if (
      ...
      dados.secondaryPais != "" &&
      dados.secondaryGold != "" &&
      dados.secondarySilver != "" &&
      dados.secondaryBronze != "" &&
      dados.tertiaryPais != "" &&
      dados.tertiaryGold != "" &&
      dados.tertiarySilver != "" &&
      dados.tertiaryBronze != ""
    ) {
      if (dados.email.includes("@")) {
        if (
          dados.primaryPais != dados.secondaryPais &&
          dados.secondaryPais != dados.tertiaryPais &&
          dados.tertiaryPais != dados.primaryPais
        ) {
              ...
              success: (dados) => {
                ...
                if (dados.email) {
                  ...
                  window.location.href =
                    "http://localhost/oi-olimpiadas/error.php";
                }
              },
              error: (erro) => {
                console.log(erro);
                window.location.href =
                  "http://localhost/oi-olimpiadas/congrats.php";
              },
            });
          ...
          $("#modal-paises-diferentes").modal("show");
        }
      } else {
        $("#modal-email-valido").modal("show");
      }
    } else {
      $("#modal-campos-vazios").modal("show");
    }
  });
});
